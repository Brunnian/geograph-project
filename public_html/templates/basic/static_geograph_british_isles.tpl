{assign var="page_title" value="Geograph Britain and Ireland"}
{include file="_std_begin.tpl"}

 <h2>Geograph British Isles</h2>

<p>Until February 2010 we went by the title "Geograph British Isles", since when we have been 
calling the project "<a href="http://www.geograph.org.uk/">Geograph Britain and Ireland</a>" and usin the following tag line:</p>

<div class="interestBox">
	The Geograph project aims to collect geographically
...
<div class="interestBox">
	Geograph Britain & Ireland is a web-based project to collect and reference geographically representative images of every square kilometre of our islands.
</div>
